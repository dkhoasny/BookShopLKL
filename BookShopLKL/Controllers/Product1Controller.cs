    ...
    public class Product1Controller : Controller
    {
        ...
        public ActionResult AddToCart(int id)
        {
            ...
            OrderDetail OD = new OrderDetail
            {
                ...
                TotalAmount = 1 * product.UnitPrice,
                Product = product
            };
            ...
            // Check if returnURL exists in TempData, and provide a fallback if not
            ...
            {
                // Redirect to index or another safe default page
                return RedirectToAction("Index");
            }
        }
        ...
        //    {
        //        ProductID = id,
        //        Quantity = quantity, // Sử dụng giá trị quantity từ form
        //        UnitPrice = product.UnitPrice,
        //        TotalAmount = quantity * product.UnitPrice, // Cập nhật tổng số tiền
        //        Product = product
        //    };
